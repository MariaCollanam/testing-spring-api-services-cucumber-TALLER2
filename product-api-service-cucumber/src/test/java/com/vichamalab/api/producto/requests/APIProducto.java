...
public class APIProducto {
	...
	public static Response actualizarProducto1(String ruta, String sku, ProductRequest request) {
		String rutaCompleta = String.format("%s{sku_creado1}/", ruta);
		return	given()
				.pathParam("sku_creado1", sku)
				.body(request)
			.when()
				.put(rutaCompleta)
			.then()
	...
	public static Response eliminarProducto1(String ruta, String sku) {
		String rutaCompleta = String.format("%s{sku_creado}/", ruta);
	   	 return given()
	   			.pathParam("sku_creado", sku)
	   	.when()
